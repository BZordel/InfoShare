    ...
    public partial class LowInventoryForm : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(formAction))
            {
                if (formAction == "add")
                {
                    msg = "Low Inventory Form successfully submitted.";
            ...
            try
            {
                ...
                using (FormContext ctx = new FormContext())
                {
                    ...
                    bodyHtml.AppendLine("<div style=\"width:50%; text-align:center;\"><img src=\"http://www.wctingle.com/img/Logo.jpg\" /><br /><br />")
                        .Append("A new Low Inventory Form has been submitted.  The details below can also be found at the following link: <a href=\"http://infoshare.wctingle.com/ReportLowInventory.aspx?formId=")
                        ...
                        .AppendLine("    <tr>")
                        .AppendLine("        <td colspan=\"4\" style=\"text-align: center;vertical-align: middle;font-weight: bold;font-size: 20px;border: 4px solid #d0604c; color:#FFF; background-color:#bc4445;\">Low Inventory Form</td>")
                        .AppendLine("    </tr>")
                        .AppendLine("    <tr>")
                        ...
                        .Append("        <td style=\"text-align:left;font-size:16px;font-weight:bold;width:25%;color:#000;\">").Append(txtPlant.Text).AppendLine("</td>")
                        .AppendLine("    </tr>")
                        .AppendLine("    <tr>")
                    ...
                    bool result = msg.SendMail("InfoShare@wctingle.com", "rzordel@gmail.com", "Low Inventory Form Submission", bodyHtml.ToString(), submittedForm, true);
                    msg.SendMail("InfoShare@wctingle.com", submittedByuserEmail, "Low Inventory Form Submission", bodyHtml.ToString(), submittedForm, false);
                    msg.SendMail("InfoShare@wctingle.com", txtCCFormTo.Text, "Low Inventory Form Submission", bodyHtml.ToString(), submittedForm, false);
