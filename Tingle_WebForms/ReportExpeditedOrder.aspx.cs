...
namespace Tingle_WebForms
{
    public partial class ReportExpeditedOrder : System.Web.UI.Page
    {
            ...
            )
        {
            ...
            {
                ExpeditedOrderFormList = ExpeditedOrderFormList.Where(forms => forms.RequestHandler.Contains(ExpeditorHandling.Trim()));
            }
        ...
        protected void fvReport_ItemUpdating(object sender, FormViewUpdateEventArgs e)
        {
            ...
            myForm.RequestHandler = txtExpeditorHandling.Text;
        ...
        public void SendCompletedEmail(Int32 FormId)
        {
            ...
            bodyHtml.AppendLine("<div style=\"width:50%; text-align:center;\"><img src=\"http://www.wctingle.com/img/Logo.jpg\" /><br /><br />")
                ...
                .AppendLine("    <tr>")
                .AppendLine("        <td colspan=\"4\" style=\"text-align: center;vertical-align: middle;font-weight: bold;font-size: 20px;border: 4px solid #d0604c; color:#FFF; background-color:#bc4445;\">Expedited Order Form Completed</td>")
                .AppendLine("    </tr>")
                .AppendLine("    <tr>")
                ...
                .AppendLine("    </tr>")
                .AppendLine("    <tr>")
                .AppendLine("        <td colspan=\"4\" style=\"text-align:center;font-size:16px;font-weight:bold;color:#bc4445;\">Expeditor Handling: </td>")
                .AppendLine("    </tr>")
                .AppendLine("    <tr>")
            ...
            bool result = msg.SendMail("InfoShare@wctingle.com", "rzordel@gmail.com", "Expedited Order Form Completion", bodyHtml.ToString(), submittedForm, true);
            msg.SendMail("InfoShare@wctingle.com", submittedByuserEmail, "Expedited Order Form Completion", bodyHtml.ToString(), submittedForm, false);
            msg.SendMail("InfoShare@wctingle.com", myForm.CCFormToEmail, "Expedited Order Form Completion", bodyHtml.ToString(), submittedForm, false);
            msg.SendMail("InfoShare@wctingle.com", myForm.CCCompletedFormToEmail, "Expedited Order Form Completion", bodyHtml.ToString(), submittedForm, false);
        }
