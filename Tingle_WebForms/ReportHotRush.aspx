...
<script type="text/javascript">
    ...
    function WireUpFormFields() {
        ...
        $("#<%= txtEntireOrderOrLineNumber.ClientID %>").bind("keyup", function (e) {
            __doPostBack('<%= txtEntireOrderOrLineNumber.ClientID %>', '');
        });
    ...
    <div class="divcenter">
        <asp:Panel ID="pnlFilter" runat="server">
            <table>
                ...
                <tr>
                    <td colspan="4" class="tdcenter">
                        <asp:LinkButton runat="server" ID="btnResetFilters" PostBackUrl="~/ReportHotRush.aspx" CssClass="normalButton" Text="Reset Filters" AutoPostBack="true"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <asp:Panel runat="server" ID="pnlReport">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="txtEntireOrderOrLineNumber" EventName="TextChanged" />
        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
            ...
            <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.HotRushForm" SelectMethod="GetFormDetails"
                ...
                <EditItemTemplate>
                    ...
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">Hot Rush Report Details</td>
                        </tr>
                        <tr>
                        ...
                        <tr runat="server" id="trCompleted3" visible="false">
                            <td colspan="4" class="tdcenter">CC Receipt To: 
                                ...
                                <asp:RegularExpressionValidator ID="regexCCFormTo" runat="server" ErrorMessage="Invalid Email Address" ForeColor="Red" Font-Size="12px" 
                                    ControlToValidate="txtCCCompletedFormToEmail"
