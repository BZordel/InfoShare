<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepAdvPriceChangeRequest.aspx.cs" Inherits="Tingle_WebForms.RepAdvPriceChangeRequest" %>
        ...
        <ContentTemplate>
            <div class="divcenter">
                <asp:Panel ID="pnlReport" runat="server">
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">Advanced Price Change Request Report</td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <a href="RepPriceChangeRequestForm.aspx">Click for Basic Search</a></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" class="tdcenter">
                                ...
                                <br />
                                <a href="RepAdvPriceChangeRequest.aspx">Clear Report</a>
                            </td>
                        </tr>
