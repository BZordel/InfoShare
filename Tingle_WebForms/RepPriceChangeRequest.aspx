<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepPriceChangeRequest.aspx.cs" Inherits="Tingle_WebForms.RepPriceChangeRequest" %>
        ...
        <ContentTemplate>
            <div class="divcenter">
                <asp:Panel ID="pnlReport" runat="server">
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">Price Change Request Report</td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <a href="RepAdvPriceChangeRequest.aspx">Click for Advanced Search</a><br /><br /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <br />
                                <a href="RepPriceChangeRequest.aspx">Clear Report</a><br /><br />
                            </td>
                        </tr>
                        ...
                        OnItemUpdating="fvReport_ItemUpdating" OnDataBound="fvReport_DataBound">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="tdright"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Line # field is required." 
                                ...
                                <tr>
                                    ...
                                    <td class="tdright"><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Quantity field is required." 
                                        ControlToValidate="txtQuantityEdit" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>Quantity:</td>
                                    <td class="tdleft"><asp:TextBox ID="txtQuantityEdit" runat="server" Text='<%# Bind("Quantity") %>'></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="tdright"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Sales Rep field is required." 
                                        ControlToValidate="txtSalesRepEdit" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>Sales Rep:</td>
                                    <td class="tdleft"><asp:TextBox ID="txtSalesRepEdit" runat="server" Text='<%# Bind("SalesRep") %>'></asp:TextBox></td>
                                    <td class="tdright"><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Product field is required." 
                                        ControlToValidate="txtProductEdit" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>Product:</td>
                                    <td class="tdleft"><asp:TextBox ID="txtProductEdit" runat="server" Text='<%# Bind("Product") %>'></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="tdright"><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Order # field is required." 
                                        ControlToValidate="txtOrderNumberEdit" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>Order #:</td>
                                    <td class="tdleft"><asp:TextBox ID="txtOrderNumberEdit" runat="server" Text='<%# Bind("OrderNumber") %>'></asp:TextBox></td>
                                    ...
                                    <td class="tdleft"><asp:TextBox ID="txtPriceEdit" runat="server" Text='<%# Bind("Price") %>'></asp:TextBox></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tdleft"><asp:TextBox ID="txtCrossRefOldOrderNumberEdit" runat="server" Text='<%# Bind("CrossReferenceOldOrderNumber") %>'></asp:TextBox></td>
                                    <td class="tdright"></td>
                                    <td class="tdleft"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4" class="tdcenter"><asp:TextBox ID="txtAdditionalInfoEdit" runat="server" TextMode="MultiLine" Rows="5" Width="700"
                                        Text='<%# Bind("AdditionalInfo") %>'></asp:TextBox></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="4" class="tdcenter"><asp:TextBox ID="txtRequestHandlerEdit" runat="server" Text='<%# Bind("RequestHandler") %>'></asp:TextBox></td>
                                </tr>
                                <tr>
