<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepAdvArchiveExpeditedOrder.aspx.cs" Inherits="Tingle_WebForms.Reports.RepAdvArchiveExpeditedOrderForm" EnableEventValidation="true" %>
        ...
        <ContentTemplate>
            <div class="divcenter">
                <asp:Panel ID="pnlReport" runat="server">
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">Advanced Archive Expedited Orders Report</td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <a href="RepArchiveExpeditedOrder.aspx">Click for Basic Search</a></td>
                        </tr>
                        <tr>
                    ...
                    <asp:TextBox ID="txtFromDate" runat="server" Width="100" />
                                To:
                    <asp:TextBox ID="txtToDate" runat="server" Width="100" /></td>
                        </tr>
                        <tr>
                            <td class="tdcenter" colspan="2">Install Date:</td>
                            <td colspan="2" class="tdleft">From:
                        <asp:TextBox type="text" ID="txtInstallFrom" size="20" runat="server" Style="width: 100px;" />
                                To:
                        <asp:TextBox type="text" ID="txtInstallTo" size="20" runat="server" Style="width: 100px;" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="tdleft">
                                <asp:TextBox ID="txtExpeditorHandling" runat="server"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td colspan="4" class="tdcenter">
                                ...
                                <br />
                                <a href="RepAdvArchiveExpeditedOrder.aspx">Clear Report</a>
                            </td>
                        </tr>
                ...
                <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                    ...
                    <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.ExpeditedOrderForm" SelectMethod="GetFormDetails"
                        BackColor="White" BorderStyle="None" DataKeyNames="ExpeditedOrderFormID" DefaultMode="Edit" UpdateMethod="UpdateForm" OnDataBound="fvReport_DataBound">
                            <EditItemTemplate>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="tdleft">
                                        <asp:DropDownList ID="ddlExpediteCodeEdit" runat="server" SelectMethod="GetExpediteCodes"
                                            DataTextField="Code" DataValueField="ExpediteCodeID" AppendDataBoundItems="true"
                                            style="border-style:inset;" OnDataBinding="ddlExpediteCodeEdit_DataBinding"
                                            Enabled="false">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="tdleft"><asp:TextBox ID="lblSubmittedByEdit" Enabled="false" runat="server" Text='<%#: Eval("SubmittedByUser") %>'></asp:TextBox></td>
                                    <td class="tdright">Modified By:</td>
                                    <td class="tdleft"><asp:TextBox ID="lblModifiedByEdit" Enabled="false" runat="server" Text='<%#: Eval("ModifiedByUser") %>'></asp:TextBox>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
