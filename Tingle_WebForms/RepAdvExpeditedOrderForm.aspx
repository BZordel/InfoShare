<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RepAdvExpeditedOrderForm.aspx.cs" Inherits="Tingle_WebForms.Reports.RepAdvExpeditedOrderForm" EnableEventValidation="true" %>
        ...
        <ContentTemplate>
            <div class="divcenter">
                <asp:Panel ID="pnlReport" runat="server">
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">Advanced Expedited Orders Report</td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <a href="RepExpeditedOrderForm.aspx">Click for Basic Search</a></td>
                        </tr>
                        <tr>
                    ...
                    <asp:TextBox ID="txtToDate" runat="server" Width="100" /></td>
                        ...
                        <tr>
                            <td colspan="4" class="tdcenter">
                                ...
                                <br />
                                <a href="RepAdvExpeditedOrderForm.aspx">Clear Report</a>
                            </td>
                        </tr>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="tdleft">
                                        ...
                                        <asp:Label ID="lblExpediteCodeDescEdit" runat="server" Text="" CssClass="smallText"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="tdright">
