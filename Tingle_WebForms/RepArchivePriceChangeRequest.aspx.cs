...
{
    public partial class RepArchivePriceChangeRequest : System.Web.UI.Page
    {
            ...
            )
        {
            ...
            if (ctx.PriceChangeRequestForms.Any(f => f.Status.StatusText == "Completed"))
            {
                ...
                {
                    priceChangeRequestFormList = priceChangeRequestFormList.Where(forms => forms.SubmittedByUser == currentUser.UserName);
                }
