...
<script type="text/javascript">
    ...
    function WireUpFormFields() {
        ...
        $("#<%= txtExpeditorHandling.ClientID %>").bind("keyup", function (e) {
            __doPostBack('<%= txtExpeditorHandling.ClientID %>', '');
        });
        ...
        <asp:Panel ID="pnlFilter" runat="server">
            <table>
                ...
                <tr>
                    ...
                    <td class="tdleft">
                        <asp:TextBox ID="txtExpeditorHandling" runat="server" AutoPostBack="true"></asp:TextBox>
                    </td>
                ...
                <tr>
                    <td colspan="4" class="tdcenter">
                        <asp:LinkButton runat="server" ID="btnResetFilters" PostBackUrl="~/ReportExpeditedOrder.aspx" CssClass="normalButton" Text="Reset Filters" AutoPostBack="true"></asp:LinkButton>
                    </td>
                </tr>
            </table>
        </asp:Panel>
        <asp:Panel runat="server" ID="pnlReport">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="txtExpeditorHandling" EventName="TextChanged" />
                            ...
                            <td>
                                <asp:GridView ID="gvReport" runat="server" AllowSorting="True" AllowCustomPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Expeditor Handling" SortExpression="RequestHandler">
                                            <ItemTemplate>
                                                <asp:Label ID="lblExpeditorHandling" runat="server" Text='<%#: Item.RequestHandler %>' ToolTip='<%#: Item.RequestHandler %>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Width="15%" />
                                        </asp:TemplateField>
        ...
        <asp:Panel ID="pnlDetails" runat="server" Visible="false">
            ...
            <asp:FormView ID="fvReport" runat="server" ItemType="Tingle_WebForms.Models.ExpeditedOrderForm" SelectMethod="GetFormDetails"
                ...
                <EditItemTemplate>
                    ...
                    <table>
                        <tr class="trheader">
                            <td colspan="4" class="tdheader">Expedited Order Report Details</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" class="tdcenter">
                                <asp:TextBox ID="txtExpeditorHandlingEdit" runat="server" Text='<%# Bind("RequestHandler") %>'></asp:TextBox></td>
                        </tr>
