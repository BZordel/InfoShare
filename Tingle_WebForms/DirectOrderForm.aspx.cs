            ...
            try
            {
                ...
                using (FormContext ctx = new FormContext())
                {
                    ...
                    bodyHtml.AppendLine("<div style=\"width:50%; text-align:center;\"><img src=\"http://www.wctingle.com/img/Logo.jpg\" /><br /><br />")
                        .Append("A new Direct Order Form has been submitted.  The details below can also be found at the following link: <a href=\"http://infoshare.wctingle.com/ReportDirectOrder.aspx?formId=")
                        ...
                        .AppendLine("    <tr>")
                        .AppendLine("        <td colspan=\"4\" style=\"text-align: center;vertical-align: middle;font-weight: bold;font-size: 20px;border: 4px solid #d0604c; color:#FFF; background-color:#bc4445;\">Direct Order Form</td>")
                        .AppendLine("    </tr>")
                        .AppendLine("    <tr>")
                    ...
                    bool result = msg.SendMail("InfoShare@wctingle.com", "rzordel@gmail.com", "Direct Order Form Submission", bodyHtml.ToString(), submittedForm, true);
                    msg.SendMail("InfoShare@wctingle.com", submittedByuserEmail, "Direct Order Form Submission", bodyHtml.ToString(), submittedForm, false);
